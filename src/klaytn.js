...
const util = require('util');
	...
	BlockSDK.Klaytn = function(api_token = ''){
		...
		this.sendToAddress = function(request = {}) {
			...
			return this.request("POST",`/klay/addresses/${request['from']}/sendtoaddress`,{
				"to" : request['to'],
		...
		this.getKIP7Sign = function(request = {}) {
			if(typeof request['private_key'] == 'undefined') request['private_key']=null;
		...
		this.getKIP7Feedelegated = function(request = {}) {
			if(typeof request['private_key'] == 'undefined') request['private_key']=null;
			...
			return this.request("POST",`/klay/kip7-tokens/${request['contract_address']}/${request['fee_payer']}/feedelegated`,{
				"from" : request['from'],
				"to" : request['to'],
				"amount" : request['amount'],
				"private_key" : request['private_key'],
		...
		this.getMultiNftCreator = function(request = {}) {
			...
			return this.request("GET",`/klay/kip37-tokens/${request['contract_address']}/creator`,{
				"offset" : request['offset'],
				"limit"  : request['limit']
			});
		}
		...
		this.getMultiNftInfo = function(request = {}) {
			return this.request("GET",`/klay/kip37-tokens/${request['contract_address']}/info`,{
			});
		}
...
module.exports = BlockSDK.Klaytn;
util.inherits(BlockSDK.Klaytn, Base);
